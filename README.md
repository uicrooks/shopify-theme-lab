...
<img width="100%" src=".config/.readme/auto-reload-demo.gif" alt="Shopify Starterkit auto reload demo" style="border-radius: 5px; box-shadow: 0 10px 20px rgba(0,0,0,.15);">
