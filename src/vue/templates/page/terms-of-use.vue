<template>
  <section class="terms-of-use">
    <text-only-banner
      banner-text="WEBSITE TERMS AND CONDITIONS OF USE"
    />
    <div class="terms-container">
      <div class="terms-content">
        ...
        >
          ...
          <p class="terms-description">
            The following Terms of Use (“Terms”) apply to and govern your access to and use of any website, mobile website, social media site, software, email exchange of information, and any other digital platform, the Program (as defined in these Terms), including any services, features, pages, and functions contained or offered therein, including any transactions, orders, sales, purchases, or the acquisition of goods or products (collectively the “Service”), that are owned, operated, or provided by Dr. Squatch, Inc., or any of its subsidiaries, divisions, and affiliates (“Dr. Squatch”)
            <br>
            <br>
            Dr. Squatch offers the Service, including all information tools, services, goods, and products available, to you conditioned upon your acceptance of all terms, conditions, polices and notices stated herein or incorporated by reference. Please read these Terms carefully before using our Service or making any transaction, order or purchase. By making any transaction, order or purchase or by visiting or otherwise using the Service in any manner, you acknowledge and accept without limitation or qualification, that you have read and understood these Terms and you agree to be bound by them. You also acknowledge, agree and consent to the terms of our <a href="/pages/privacy-policy">Privacy Policy </a> which is incorporated herein by reference. If for any reason you do not accept and agree to these Terms or those set forth in the <a href="/pages/privacy-policy">Privacy Policy </a>, then accessing the Service is strictly prohibited and you must immediately exit.
            <br>
            <br>
        ...
        >
          ...
          <p class="terms-description">
            Squatch Perks is our way of rewarding you for being the manliest, most natural clean version of you that you can be! As a Squatch Perks Member you are subject to Dr. Squatch’s Terms of Use and Privacy Policy as well as the following additional terms and conditions:
            <br>
            <ul>
              <li>
        ...
        >
          ...
          <p class="terms-description">
            ...
            <br>
            <a href="mailto:support@drsquatch.com">
              support@drsquatch.com
            </a>
            <br>
            <br>
